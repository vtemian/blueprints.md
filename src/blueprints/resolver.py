...
from .parser import Blueprint, BlueprintParser, BlueprintReference
...
class ResolvedBlueprint:
    ...
    generation_order: List[Blueprint] = field(default_factory=list)  # Topologically sorted
...
class BlueprintResolver:
    ...
    def _resolve_reference(self, ref: BlueprintReference, from_blueprint: Blueprint) -> Optional[Blueprint]:
    ...
    def _resolve_relative_import(self, relative_path: str, from_blueprint: Blueprint) -> str:
    ...
    def _get_resolved_module_name(self, ref: BlueprintReference, from_blueprint: Blueprint) -> Optional[str]:
    ...
    def _topological_sort(self, all_blueprints: Dict[str, Blueprint], graph: Dict[str, Set[str]]) -> List[Blueprint]:
